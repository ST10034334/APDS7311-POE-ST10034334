        ...
        <div className="row justify-content-center">
            <div className="col-12 content-head">
                ...
                <h1 style={{ fontSize: '64px', textAlign: 'center', marginBottom: '20px' }}>✅</h1>
                    <h3 className="mbr-section-title mbr-fonts-style align-center mb-0 display-5"><strong>Your payment is being processed.</strong></h3>
                    <h3 className="mbr-section-title mbr-fonts-style align-center mb-0 display-5"><strong>Please wait while your payment is being verified.</strong></h3>
